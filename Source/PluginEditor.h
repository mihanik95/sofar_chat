...
private:
    ...
    void setupSlider(juce::Slider& slider, const juce::String& name, const juce::String& suffix, bool isMainControl = false);
    ...
    struct PresetData {
        ...
        float airAbsorption;
        float temperature;
        // Note: Signal control parameters (distance, panning, volumeCompensation) are NOT included
    };
    ...
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> airAbsorptionAttachment;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> volumeCompensationAttachment;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> temperatureAttachment;
